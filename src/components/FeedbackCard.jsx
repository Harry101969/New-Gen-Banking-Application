...
const FeedbackCard = ({ content, name, title, img }) => (
  <div className="flex flex-col justify-between px-10 py-12 rounded-[20px] max-w-[370px] md:mr-10 sm:mar-5 mr-0 my-5 feedback-card ">
  ...
  <div className="flex flex-row">
   <img src={img} alt="name-person" className="w-[48px] h-[48px] rounded-full " />
